...
Tr0 = 377.05 #temperatura da corrente de alimentação de reagentes (K)
...
arquivo_vs_t = 'determinacao_t_amostragem.csv'
...
reator1.Simu_temporalCSTR(Ca_inicial,Cb_inicial,Tr_inicial,Tc_inicial,Ca0,Tr0,Qc,criterio_erro,H,qr,arquivo_vs_t)